...
var tests = []test{
	...
	{"mapcar fn list eval", "(7 9 11)", "(mapcar 'plus '(1 2 3 4) (cdr '(5 6 7 8)))"},
	{"mapcar fn 3 lists", "(6 6 6)", "(mapcar 'plus '(1 1 1) '(2 2 2) '(3 3 3))"},
	{"mapcar fn 3 lists uneven 1", "(6)", "(mapcar 'plus '(1) '(2 2 2) '(3 3 3))"},
	{"mapcar fn 3 lists uneven 2", "(6 6)", "(mapcar 'plus '(1 1 1), '(2 2) '(3 3 3))"},
	{"mapcar fn 3 lists uneven 3", "(6 6)", "(mapcar 'plus '(1 1 1) '(2 2 2) '(3 3))"},
